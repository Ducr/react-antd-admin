...
下面是一个典型的目录结构 [`src/api/user`](https://github.com/Ducr/react-antd-admin/tree/main/src/api/user)：
...
如果页面下有页面，则可以继续嵌套目录，例如：[`src/api/system`](https://github.com/Ducr/react-antd-admin/tree/main/src/api/system)。
...
`request.ts` 是封装了 `[Ky](https://github.com/sindresorhus/ky)` 的请求库，代码实现请看 `[src/utils/request](https://github.com/Ducr/react-antd-admin/tree/main/src/utils/request)`。
